...
const brands = [
  { name: 'Panadol', slug: 'panadol', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 1, isFeatured: true },
  { name: 'CeraVe', slug: 'cerave', logoUrl: '/images/brands/crave.png', sortOrder: 2, isFeatured: true },
  { name: 'Mustela', slug: 'mustela', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 3, isFeatured: true },
  { name: 'Vichy', slug: 'vichy', logoUrl: '/images/brands/vichy.jpg', sortOrder: 4, isFeatured: true },
  { name: 'La Roche-Posay', slug: 'la-roche-posay', logoUrl: '/images/brands/laroche.png', sortOrder: 5, isFeatured: true },
  { name: 'Strepsils', slug: 'strepsils', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 6, isFeatured: true },
  { name: 'Brufen', slug: 'brufen', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 7, isFeatured: false },
  { name: 'Congestal', slug: 'congestal', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 8, isFeatured: false },
  { name: 'Otrivin', slug: 'otrivin', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 9, isFeatured: false },
  { name: 'Bioderma', slug: 'bioderma', logoUrl: '/images/brands/bioderma.png', sortOrder: 10, isFeatured: false },
  { name: 'Eva', slug: 'eva', logoUrl: '/images/brands/eva.png', sortOrder: 11, isFeatured: false },
  { name: 'The Ordinary', slug: 'the-ordinary', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 12, isFeatured: false },
  { name: 'Centrum', slug: 'centrum', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 13, isFeatured: false },
  { name: 'Dettol', slug: 'dettol', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 14, isFeatured: false },
  { name: 'Nivea', slug: 'nivea', logoUrl: '/images/brands/nivea.gif', sortOrder: 15, isFeatured: false },
  { name: 'Pampers', slug: 'pampers', logoUrl: '/images/brands/Pampers.png', sortOrder: 16, isFeatured: false },
  { name: "Johnson's", slug: 'johnsons', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 17, isFeatured: false },
  { name: 'Sudocrem', slug: 'sudocrem', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 18, isFeatured: false },
  { name: 'Accu-Chek', slug: 'accu-chek', logoUrl: '/images/brands/accuchek.png', sortOrder: 19, isFeatured: false },
  { name: 'Sensodyne', slug: 'sensodyne', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 20, isFeatured: false },
  { name: 'Listerine', slug: 'listerine', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 21, isFeatured: false },
  { name: 'Oral-B', slug: 'oral-b', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 22, isFeatured: false },
  { name: 'Pantene', slug: 'pantene', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 23, isFeatured: false },
  { name: 'Mielle', slug: 'mielle', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 24, isFeatured: false },
  { name: 'Health Essentials', slug: 'health-essentials', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 25, isFeatured: false },
  { name: 'Maybelline', slug: 'maybelline', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 26, isFeatured: false },
  { name: 'Essence', slug: 'essence', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 27, isFeatured: false },
  { name: 'Ensure', slug: 'ensure', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 28, isFeatured: false },
  { name: 'Slim Fast', slug: 'slim-fast', logoUrl: '/images/brands/slimfast.png', sortOrder: 29, isFeatured: false },
  { name: 'Gillette', slug: 'gillette', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 30, isFeatured: false },
  { name: 'Durex', slug: 'durex', logoUrl: '/images/brands/elkhabiry-logo.png', sortOrder: 31, isFeatured: false },
  { name: 'Clearblue', slug: 'clearblue', logoUrl: '/images/brands/clearblue.png', sortOrder: 32, isFeatured: false },
  { name: 'Femfresh', slug: 'femfresh', logoUrl: '/images/brands/femfresh.png', sortOrder: 33, isFeatured: false },
];
